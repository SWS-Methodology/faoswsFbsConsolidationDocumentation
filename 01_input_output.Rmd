...
![(\#fig:AreaAggregatesDT) Figure 1.1. Datatable presenting the list of area aggregates to include in the FBS consolidation process.](./images/fbs_consolidation_area_aggregates.png)
...
![(\#fig:ElementsDT) Figure 1.2. Datatable presenting the list of input and output elements, including conversion multipliers and formulas used to compute compound elements.](./images/fbs_consolidation_elements.png)
...
As depicted in Figure \@ref(fig:ExceptionsDT), the datatable has **ten columns**:\
...
![(\#fig:ExceptionsDT) Figure 1.3. Datatable presenting the list of exceptions to be applied within the FBS consolidation process.](./images/fbs_consolidation_exceptions.png)
...
![(\#fig:CodeMappingDT) Figure 1.4. Datatable defining the mapping operations between input codes and output (consolidated) codes.](./images/fbs_consolidation_code_mapping.png)
...
![(\#fig:LogsDT) Figure 1.5. Datatable providing detailed information on all the runs of the *fbs_consolidation* plugin.](./images/fbs_consolidation_logs.png)
