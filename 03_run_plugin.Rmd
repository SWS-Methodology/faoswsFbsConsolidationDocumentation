...
![(\#fig:secondaryLaunch) Figure 4.2. First input parameters' selection for the *fbs_consolidation* plugin.](./images/fbs_secondary_launch.png)
...
![(\#fig:secondaryError) Figure 4.3. Example of error produced by launching a non-core plugin from a session but selecting a dataset as a value for a *Secondary Dataset* input parameter.](./images/fbs_secondary_error.png)
